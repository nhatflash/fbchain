...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/restaurant/{restaurantId}/order/{orderId}/confirm": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/restaurant/{restaurantId}/staff": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "CreateRestaurantStaff body",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/client.CreateRestaurantStaffRequest"
                        }
                    }
                ],
                "responses": {}
    ...
    "definitions": {
        ...
        "client.CreateRestaurantStaffRequest": {
            "type": "object",
            "required": [
                "address",
                "birthdate",
            ...
            "properties": {
                ...
                "type": {
                    "$ref": "#/definitions/enum.RestaurantStaffType"
                }
            }
        },
