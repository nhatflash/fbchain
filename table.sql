...
CREATE TABLE payments (
	id BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
	order_id BIGINT NOT NULL REFERENCES orders(id) ON UPDATE CASCADE ON DELETE RESTRICT,
	amount DECIMAL(18,2) NOT NULL,
...
CREATE TYPE restaurant_order_status AS ENUM ('PENDING', 'WORKING', 'FINISHED', 'CANCELED');

CREATE TABLE restaurant_orders (
	id BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
	restaurant_id BIGINT NOT NULL REFERENCES restaurants(id) ON UPDATE CASCADE ON DELETE RESTRICT,
	table_id BIGINT NOT NULL REFERENCES restaurant_tables(id) ON UPDATE CASCADE ON DELETE RESTRICT,
	amount DECIMAL(18,2) NOT NULL,
...
CREATE TYPE restaurant_staff_type AS ENUM ('MANAGING', 'SERVING', 'COOKING');
...
CREATE TABLE restaurant_staffs (
	...
	restaurant_id BIGINT NOT NULL REFERENCES restaurants(id) ON UPDATE CASCADE ON DELETE RESTRICT,
	code VARCHAR(50) UNIQUE NOT NULL,
	type restaurant_staff_type NOT NULL,
...
CREATE TYPE staff_shift_type AS ENUM ('FULLTIME', 'PARTTIME')
