...
func (r *queryResolver) Users(ctx context.Context) ([]*gqlModel.User, error) {
	var err error
	_, err = CheckRoleAccessUser(ctx, "ADMIN")
	if err != nil {
		return nil, err
	}
...
func (r *queryResolver) Staffs(ctx context.Context) ([]*gqlModel.Staff, error) {
	panic(fmt.Errorf("not implemented: Staffs - staffs"))
}

// Staff is the resolver for the staff field.
func (r *queryResolver) Staff(ctx context.Context, id string) (*gqlModel.Staff, error) {
...
// User is the resolver for the user field.
func (r *staffResolver) User(ctx context.Context, obj *gqlModel.Staff) (*gqlModel.User, error) {
